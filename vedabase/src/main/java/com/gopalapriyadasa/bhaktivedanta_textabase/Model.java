...
//            mCurrentDir = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
            mCurrentDir = Environment.getExternalStorageDirectory();

            Log.i(TAG, String.valueOf(mCurrentDir));
        } else {
            mCurrentDir = MainActivity.getInstance().getFilesDir().getAbsoluteFile();
